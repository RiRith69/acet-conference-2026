...
in lighting, angles, distances and backgrounds. Figure \ref{fig:sign_classes} demonstrates the complete set of traffic sign classes included in the proposed dataset.
...
The distribution of annotated across the 42 classes demonstrated in Figure \ref{fig:distribution}, displaying the variance in each class
...
evaluation of the train models. The number of propotion of images assigned to each subset are summariezed in Table \ref{tab:magnetic-properties}.
\begin{figure}[ht]
    \centering
